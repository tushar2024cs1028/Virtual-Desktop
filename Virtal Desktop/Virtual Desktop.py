...
dic={"tushar":"tusharsharma0648@gmail.com"}
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('tusharsharma0648@gmail.com', 'Password')#enter password
    server.sendmail('tusharsharma0648@gmail.com', to, content)
    server.close()
